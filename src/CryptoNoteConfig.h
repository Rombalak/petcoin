...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x23df1f;
...
const char     CRYPTONOTE_NAME[]                             = "TiinCoin";
...
const int      P2P_DEFAULT_PORT                              = 66666;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 66667;
